...
router.get('/', async (req, res) => {
 ...
 const response= await fetch("http://SOLMAN.kaartech.com:8000/sap/bc/srt/rfc/sap/zbapi_inquiry_getdetails_dl/100/zbapi_inquiry_getdetails_dl/zbapi_inquiry_getdetails_dl",
   {
   ...
   data =parser.parseString(response, (err,data) => {
         res_data = data['soap-env:Envelope']['soap-env:Body'][0]['n0:ZBAPI_INQUIRY_GETDETAILS_DLResponse'][0]['IT_FINAL'][0]['item'];
